...
public class GalleryController {
	...
	public String insert(Model model) {
		GalleryVO galleryVO = GalleryVO.builder().g_up_image("no_Image.jpg").
				g_origin_image("no_Image.jpg")
				.build();
	 ...
	 * 파일을 수신하는 객체
	 * 
	 * MultipartHttpMessageReader : form 의 input[type='file'] tag 에
	 * 담겨서 전달되는 여러개의 파일을 수신하는 객체이다.
	 * 여기에는 전대 @Reqparam 을 붙여서는 안된다.
	 */
	...
	public String insert(GalleryVO galleryVO,
		...
		try {
			...
			/*
			 * Multi file 의 경우 매개변수의 이름과 form 에서 전달한 이름은
			 * 전혀 연관이없다. Multi 파일의 경우는 변수.getFiles() method 를 실행할때
