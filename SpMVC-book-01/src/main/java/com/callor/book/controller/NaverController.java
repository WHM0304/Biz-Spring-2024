...
//		params.put(KEY_Naver_Client_Secret, VALUE_Naver_Client_Secret);
		 ...
		 * naver 의 API(대부분의 open API)들은 요청을 할때 GET method 방식을 사용해야하는데
		 ...
		 * 담아서 보낼수 있다. 
		 */
		ResponseEntity<NBooks> result =
				restTemplate.exchange(naver_book_url,HttpMethod.GET,params,NBooks.class);
